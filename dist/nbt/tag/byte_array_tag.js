...
class ByteArrayTag {
    constructor(name = '', value = []) {
        this.id = tag_identifiers_1.default.BYTE_ARRAY_TAG;
        this.name = name;
        this.value = value;
    }
    read(stream) {
        ...
        for (const _ of (0, range_1.default)(0, length)) {
            this.value.push(stream.read_byte_tag());
        }
    }
    write(stream) {
...
exports.default = ByteArrayTag;
//# sourceMappingURL=byte_array_tag.js.map